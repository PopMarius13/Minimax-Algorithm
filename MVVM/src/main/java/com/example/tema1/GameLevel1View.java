            ...
            button.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    if (buttonsCheck[(x - 1) * 4 + y] != 1) {
                        ...
                        vmGame.playerMove(new Point(x - 1, y - 1, arrow));
                        int finishGame = vmGame.finishGame(true);
                        if(finishGame != 0){
                            finishGame(finishGame);
                        } else {
                            Point point = vmGame.computerMove();
                            ...
                            finishGame = vmGame.finishGame(false);
                            if(finishGame != 0) {
                                finishGame(finishGame);
                            }
                        }
